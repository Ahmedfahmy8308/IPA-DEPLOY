import{r as i,K as F,M as Y,j as e,P as V,Q as R,T as X,U as G,m as C,A as S,a as D,y as M}from"./index-C_fr4Erx.js";import{B as P}from"./button-BPxerCch.js";import{I as j}from"./input-BJXRyxCF.js";import{T as k}from"./textarea-CvlbrZRC.js";import{C as H,a as _,c as E,b as L,d as J}from"./card-DGBTJEaR.js";import{L as c}from"./label-BCuuPS8m.js";import{u as Z}from"./index-D7xDFYpB.js";import ee from"./DashboardLayout-Ddo37TUH.js";import{C as se}from"./ConfirmationDialog-ooO5-hCw.js";import{M as T}from"./mail-DjhuuHJK.js";import{P as A}from"./phone-CrBjXmHC.js";import{M as I}from"./map-pin-CnWEuCcr.js";import{C as ae}from"./clock-CQOweA_D.js";import{L as te}from"./link-2-DGNgC8rP.js";import{S as re}from"./save-DSwG9zq0.js";import"./avatar-B0KsI8hU.js";import"./chevron-down-D0hNMIBc.js";import"./menu-DGwCjKJV.js";import"./house-BDmh6YyZ.js";import"./book-open-PhjM-7Sv.js";import"./user-Rz5BT_eB.js";import"./proxy-BRfMpYjB.js";import"./index-DPloX2HJ.js";import"./settings-DmzB8q4_.js";var b="Switch",[ie,Fe]=V(b),[oe,ne]=ie(b),B=i.forwardRef((s,t)=>{const{__scopeSwitch:r,name:o,checked:n,defaultChecked:g,required:p,disabled:l,value:u="on",onCheckedChange:f,form:h,...a}=s,[m,d]=i.useState(null),v=F(t,w=>d(w)),y=i.useRef(!1),N=m?h||!!m.closest("form"):!0,[x,z]=Y({prop:n,defaultProp:g??!1,onChange:f,caller:b});return e.jsxs(oe,{scope:r,checked:x,disabled:l,children:[e.jsx(R.button,{type:"button",role:"switch","aria-checked":x,"aria-required":p,"data-state":Q(x),"data-disabled":l?"":void 0,disabled:l,value:u,...a,ref:v,onClick:X(s.onClick,w=>{z(O=>!O),N&&(y.current=w.isPropagationStopped(),y.current||w.stopPropagation())})}),N&&e.jsx(K,{control:m,bubbles:!y.current,name:o,value:u,checked:x,required:p,disabled:l,form:h,style:{transform:"translateX(-100%)"}})]})});B.displayName=b;var U="SwitchThumb",W=i.forwardRef((s,t)=>{const{__scopeSwitch:r,...o}=s,n=ne(U,r);return e.jsx(R.span,{"data-state":Q(n.checked),"data-disabled":n.disabled?"":void 0,...o,ref:t})});W.displayName=U;var le="SwitchBubbleInput",K=i.forwardRef(({__scopeSwitch:s,control:t,checked:r,bubbles:o=!0,...n},g)=>{const p=i.useRef(null),l=F(p,g),u=Z(r),f=G(t);return i.useEffect(()=>{const h=p.current;if(!h)return;const a=window.HTMLInputElement.prototype,d=Object.getOwnPropertyDescriptor(a,"checked").set;if(u!==r&&d){const v=new Event("click",{bubbles:o});d.call(h,r),h.dispatchEvent(v)}},[u,r,o]),e.jsx("input",{type:"checkbox","aria-hidden":!0,defaultChecked:r,...n,tabIndex:-1,ref:l,style:{...n.style,...f,position:"absolute",pointerEvents:"none",opacity:0,margin:0}})});K.displayName=le;function Q(s){return s?"checked":"unchecked"}var $=B,ce=W;const q=i.forwardRef(({className:s,...t},r)=>e.jsx($,{className:C("peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=unchecked]:bg-input",s),...t,ref:r,children:e.jsx(ce,{className:C("pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0")})}));q.displayName=$.displayName;async function de(){try{const s=await fetch(`${D}Footer`);if(!s.ok)throw new Error("Network response was not ok");return(await s.json()).data}catch(s){console.error("Error fetching Data in footer:",s)}}async function he(s){const t=new FormData;s.Image&&t.append("Image",s.Image),s.Description&&t.append("Description",s.Description),s.Copyright&&t.append("Copyright",s.Copyright),s.Address&&t.append("Address",s.Address),s.Phone&&t.append("Phone",s.Phone),s.Email&&t.append("Email",s.Email),s.WorkingHours&&t.append("WorkingHours",s.WorkingHours),s.SocialMediaHTML&&t.append("SocialMediaHTML",s.SocialMediaHTML);const r=await fetch(`${D}Footer`,{method:"PUT",credentials:"include",body:t});if(!r.ok)throw new Error("Network response was not ok");return(await r.json()).data}const Re=()=>{const[s,t]=i.useState({logo:"",copyright:"© 2025 IPA",description:"Empowering education through technology.",email:"ipa@ipaegy.com",phone:"+201000998187",address:"Kafr Elsheikh, Egypt",workingHours:"9 AM - 5 PM",showSocialMedia:!0,socialMediaHtml:`
