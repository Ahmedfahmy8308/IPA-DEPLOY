import{r as i,v as F,w as Y,j as e,x as V,P as R,z as X,B as G,m as C,A as S,a as D,y as M}from"./index-BFIRCOFm.js";import{B as P}from"./button-rBvhrAfx.js";import{I as j}from"./input-C8a62OMq.js";import{T as k}from"./textarea-B26h0Sb-.js";import{C as H,a as _,c as E,b as L,d as J}from"./card-D4deD862.js";import{L as c}from"./label-DvQAFCnC.js";import{u as Z}from"./index-BJ0e7QXW.js";import ee from"./DashboardLayout-DG6aMarG.js";import{C as se}from"./ConfirmationDialog-CtCr8LY3.js";import{M as A}from"./mail-tXVTlmaL.js";import{P as I}from"./phone-C11RMwgW.js";import{M as T}from"./map-pin-BOiomF4P.js";import{C as ae}from"./clock-DNZVvydn.js";import{L as te}from"./link-2-B1If6wab.js";import{S as re}from"./save-DS__s1DR.js";import"./avatar-Chrsg1u7.js";import"./chevron-down-ClO_s6PV.js";import"./menu-D2RpImz6.js";import"./house-D_j3gpBM.js";import"./settings-CttSaOqL.js";import"./user-gTeU-oJe.js";import"./proxy-BWbRnjfR.js";import"./index-B327TQr2.js";var b="Switch",[ie,Te]=V(b),[oe,ne]=ie(b),B=i.forwardRef((s,t)=>{const{__scopeSwitch:r,name:o,checked:n,defaultChecked:g,required:u,disabled:l,value:p="on",onCheckedChange:f,form:h,...a}=s,[m,d]=i.useState(null),v=F(t,w=>d(w)),y=i.useRef(!1),N=m?h||!!m.closest("form"):!0,[x,O]=Y({prop:n,defaultProp:g??!1,onChange:f,caller:b});return e.jsxs(oe,{scope:r,checked:x,disabled:l,children:[e.jsx(R.button,{type:"button",role:"switch","aria-checked":x,"aria-required":u,"data-state":$(x),"data-disabled":l?"":void 0,disabled:l,value:p,...a,ref:v,onClick:X(s.onClick,w=>{O(Q=>!Q),N&&(y.current=w.isPropagationStopped(),y.current||w.stopPropagation())})}),N&&e.jsx(z,{control:m,bubbles:!y.current,name:o,value:p,checked:x,required:u,disabled:l,form:h,style:{transform:"translateX(-100%)"}})]})});B.displayName=b;var U="SwitchThumb",W=i.forwardRef((s,t)=>{const{__scopeSwitch:r,...o}=s,n=ne(U,r);return e.jsx(R.span,{"data-state":$(n.checked),"data-disabled":n.disabled?"":void 0,...o,ref:t})});W.displayName=U;var le="SwitchBubbleInput",z=i.forwardRef(({__scopeSwitch:s,control:t,checked:r,bubbles:o=!0,...n},g)=>{const u=i.useRef(null),l=F(u,g),p=Z(r),f=G(t);return i.useEffect(()=>{const h=u.current;if(!h)return;const a=window.HTMLInputElement.prototype,d=Object.getOwnPropertyDescriptor(a,"checked").set;if(p!==r&&d){const v=new Event("click",{bubbles:o});d.call(h,r),h.dispatchEvent(v)}},[p,r,o]),e.jsx("input",{type:"checkbox","aria-hidden":!0,defaultChecked:r,...n,tabIndex:-1,ref:l,style:{...n.style,...f,position:"absolute",pointerEvents:"none",opacity:0,margin:0}})});z.displayName=le;function $(s){return s?"checked":"unchecked"}var q=B,ce=W;const K=i.forwardRef(({className:s,...t},r)=>e.jsx(q,{className:C("peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=unchecked]:bg-input",s),...t,ref:r,children:e.jsx(ce,{className:C("pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0")})}));K.displayName=q.displayName;async function de(){try{const s=await fetch(`${D}Footer`);if(!s.ok)throw new Error("Network response was not ok");return(await s.json()).data}catch(s){console.error("Error fetching Data in footer:",s)}}async function he(s){const t=new FormData;s.Image&&t.append("Image",s.Image),s.Description&&t.append("Description",s.Description),s.Copyright&&t.append("Copyright",s.Copyright),s.Address&&t.append("Address",s.Address),s.Phone&&t.append("Phone",s.Phone),s.Email&&t.append("Email",s.Email),s.WorkingHours&&t.append("WorkingHours",s.WorkingHours),s.SocialMediaHTML&&t.append("SocialMediaHTML",s.SocialMediaHTML);const r=await fetch(`${D}Footer`,{method:"PUT",credentials:"include",body:t});if(!r.ok)throw new Error("Network response was not ok");return(await r.json()).data}const Fe=()=>{const[s,t]=i.useState({logo:"",copyright:"© 2025 IPA",description:"Empowering education through technology.",email:"ipa@ipaegy.com",phone:"+201000998187",address:"Kafr Elsheikh, Egypt",workingHours:"9 AM - 5 PM",showSocialMedia:!0,socialMediaHtml:`
